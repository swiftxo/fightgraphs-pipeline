...
class PostgresController:
    ...
    def batch_insert(self, objects: list) -> None:
        """
        Inserts a list of SQLAlchemy model instances in a single transaction.
        Args:
            objects (list): List of SQLAlchemy model instances to insert.
        """
